const Dataprivacy = () => {
  return (
    <div id="events" className="py-10 bg-white">
      <div className="container px-4 mx-auto">
        <div className="text-justify">
          <h1 className="my-4 text-xl uppercase font-bold text-[#FFC08E]">
          ...
          <p>
            ...
            Datenschutz-Grundverordnung und in Übereinstimmung mit den geltenden
          ...
          <p>
            Michaela Süßbauer & Oliver Götz haben für die Verarbeitung
          ...
          <h4 className="my-2">1. Begriffsbestimmungen</h4>
          <p>
            Die Datenschutzerklärung von Michaela Süßbauer & Oliver Götz beruht
          ...
          <p>Michaela Süßbauer & Oliver Götz</p>
          <p>Luxemburger Str., 192</p>
          <p>50937 Köln</p>
          <p>Deutschland</p>
          <p>Tel.: 017631734482</p>
          <p>E-Mail: goetzoliver89@gmail.com</p>
          ...
          {/* <p>
					...
					<p>
						Durch den Einsatz von Cookies kann die Michaela Süßbauer & Oliver
						Götz (Freiberufler) den Nutzern dieser Internetseite
          ...
          <p>
            Die Internetseite von Michaela Süßbauer & Oliver Götz erfasst mit
          ...
          <p>
            ...
            Michaela Süßbauer & Oliver Götz keine Rückschlüsse auf die
            ...
            Informationen werden durch die Michaela Süßbauer & Oliver Götz
            (Freiberufler) daher einerseits statistisch und ferner mit dem Ziel
          ...
          <h4 className="my-2">5. Kontaktmöglichkeit über die Internetseite</h4>
          <p>
            Die Internetseite von Michaela Süßbauer & Oliver Götz enthält
          ...
          <h4 className="my-2">7. Rechte der betroffenen Person</h4>
          <ul className="list-none">
            <li>
            ...
            <li>
              ...
              <p>
                ...
                bei Michaela Süßbauer & Oliver Götz gespeichert sind,
                veranlassen möchte, kann sie sich hierzu jederzeit an einen
                Mitarbeiter des für die Verarbeitung Verantwortlichen wenden.
                Der Mitarbeiter der Michaela Süßbauer & Oliver Götz
                (Freiberufler) wird veranlassen, dass dem Löschverlangen
                unverzüglich nachgekommen wird.
              </p>

              <p>
                Wurden die personenbezogenen Daten von der Michaela Süßbauer &
                Oliver Götz (Freiberufler) öffentlich gemacht und ist unser
                ...
                Michaela Süßbauer & Oliver Götz unter Berücksichtigung der
                ...
                von Michaela Süßbauer & Oliver Götz wird im Einzelfall das
            ...
            <li>
              ...
              <p>
                ...
                Daten, die von Michaela Süßbauer & Oliver Götz gespeichert sind,
                verlangen möchte, kann sie sich hierzu jederzeit an einen
                Mitarbeiter des für die Verarbeitung Verantwortlichen wenden.
                Der Mitarbeiter der Michaela Süßbauer & Oliver Götz
                (Freiberufler) wird die Einschränkung der Verarbeitung
                veranlassen.
              </p>
            </li>
            <li>
              ...
              <p>
                ...
                die betroffene Person jederzeit an Michaela Süßbauer & Oliver
                Götz wenden.
              </p>
            </li>
            <li>
              ...
              <p>
                Michaela Süßbauer & Oliver Götz verarbeiten die
              ...
              <p>
                Verarbeiten Michaela Süßbauer & Oliver Götz personenbezogene
                ...
                betroffene Person gegenüber Michaela Süßbauer & Oliver Götz der
                Verarbeitung für Zwecke der Direktwerbung, so werden Michaela
                Süßbauer & Oliver Götz die personenbezogenen Daten nicht mehr
              ...
              <p>
                ...
                betreffende Verarbeitung personenbezogener Daten, die durch
                Michaela Süßbauer & Oliver Götz zu wissenschaftlichen oder
              ...
              <p>
                ...
                Person direkt an jeden Mitarbeiter der Michaela Süßbauer &
                Oliver Götz (Freiberufler) oder einen anderen Mitarbeiter
            ...
            <li>
              ...
              <p>
                ...
                ausdrücklicher Einwilligung der betroffenen Person, treffen die
                Michaela Süßbauer & Oliver Götz angemessene Maßnahmen, um die
          ...
          <h4 className="my-2">11. Rechtsgrundlage der Verarbeitung</h4>
          <p>
          ...
          <p>
            ...
            <a href="https://abletocontract.com/">Vertragsgestaltung</a>{" "}
