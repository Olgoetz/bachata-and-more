const Impressum = () => {
  return (
    <div id="events" className="py-16 0g-white">
      <div className="container px-4 mx-auto">
        <h1 className="mt-4 text-xl uppercase font-bold text-[#FFC08E]">
          Impressum
        </h1>
        <div className="mt-4 text-sm text-justify">
          ...
          <p>
            ...
            <ul>
              <li>
                <a
                  href="https://www.flaticon.com/de/kostenlose-icons/break-dance"
                  title="break dance Icons"
                >
                  Break dance Icons erstellt von DinosoftLabs - Flaticon
                </a>
              </li>
              <li>
                <a
                  href="https://www.flaticon.com/de/kostenlose-icons/meditation"
                  title="meditation Icons"
                >
                  Meditation Icons erstellt von DinosoftLabs - Flaticon
                </a>
              </li>
              <li>
                <a
                  href="https://www.flaticon.com/de/kostenlose-icons/ubung"
                  title="Übung Icons"
                >
                  Übung Icons erstellt von DinosoftLabs - Flaticon
                </a>
              </li>
            </ul>
          </p>
