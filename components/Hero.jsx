...
const Hero = () => {
	return (
		<div id='home' className='w-full'>
			...
			<div className='flex space-x-3 h-screen items-center justify-center text-center text-white bg-fixed bg-center md:bg-cover bg-[url(../public/images/MichiyOli_parallax.jpg)]'>
